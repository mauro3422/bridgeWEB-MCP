...
Before reporting unavailable access, verify the runtime catalog and invoke the exact read-only Whiteboard tool through `bridge_tool_query` when its dedicated schema is absent. Distinguish “schema not surfaced”, “runtime tool missing”, “tool error”, and “no saved capture”; do not collapse them into one claim.
