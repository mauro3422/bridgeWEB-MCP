...
```txt
cache TypeScript Program and import graph by mtime/hash
autogenerated tool docs from schemas
deeper TypeChecker tests for aliases/barrels/path mappings
optional project-wide call graph
```
