...
$steps += Invoke-VerifyStep "test:metrics-wal-maintenance" { npm run test:metrics-wal-maintenance }
$steps += Invoke-VerifyStep "test:observability-http-liveness" { npm run test:observability-http-liveness }
