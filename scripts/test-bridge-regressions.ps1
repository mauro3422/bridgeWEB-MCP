...
for (const tool of ["run_command", "terminal_start", "terminal_write", "terminal_read", "terminal_stop", "work_once", "work_begin", "work_peek", "work_show", "work_feed", "work_finish"]) {
