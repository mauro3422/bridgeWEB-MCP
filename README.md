...
Live runtime: v0.6.135 (pending controlled restart adoption)
Packaged MSSR: 0.2.69
Mode: Streamable HTTP live; R1 trace-owner isolation + R2 automatic lifecycle preflight staged for live adoption
