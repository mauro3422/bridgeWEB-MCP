...
```text
bridge-mcp current release v0.6.134
Live runtime: v0.6.134
Packaged MSSR: 0.2.65
Mode: Streamable HTTP live; contextual low-noise notice delivery adopted and live-verified with one global history/transport
